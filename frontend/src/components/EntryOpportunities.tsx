...
import type { EntrySnapshotFile } from "../api";
...
export function EntryOpportunities({ snapshot, loading, building, onBuild }: Props) {
  ...
  return (
    <section className="panel entry-opportunities">
      ...
      {!loading && !snapshot && <p className="empty block">No entry snapshot generated yet.</p>}
