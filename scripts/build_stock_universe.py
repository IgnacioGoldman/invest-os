...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--count", type=int, default=100, help="Number of tickers to select.")
    parser.add_argument("--candidate-pool", type=int, default=700, help="How many high-liquidity candidates to score deeply.")
    parser.add_argument("--nasdaq-limit", type=int, default=12000, help="How many Nasdaq screener rows to fetch.")
    parser.add_argument("--us-target", type=int, default=85, help="Maximum US common-stock selections.")
    parser.add_argument("--adr-target", type=int, default=15, help="Maximum ADR/foreign-listed selections.")
    parser.add_argument("--max-per-sector", type=int, default=18)
