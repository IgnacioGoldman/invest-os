...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--count", type=int, default=2000, help="Number of tickers to select.")
    parser.add_argument("--candidate-pool", type=int, default=5000, help="How many high-liquidity candidates to score deeply.")
    parser.add_argument("--nasdaq-limit", type=int, default=24000, help="How many Nasdaq screener rows to fetch.")
    parser.add_argument("--us-target", type=int, default=1700, help="Maximum US common-stock selections.")
    parser.add_argument("--adr-target", type=int, default=300, help="Maximum ADR/foreign-listed selections.")
    parser.add_argument("--max-per-sector", type=int, default=400)
    ...
    parser.add_argument("--min-avg-dollar-volume", type=float, default=15_000_000)
    parser.add_argument("--min-data-quality", type=float, default=0.65)
    parser.add_argument("--spread-enrich-limit", type=int, default=400)
